...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        {{-- sidebar --}}
        <aside id="sidebar"
            class="sidebar fixed inset-y-0 left-0 z-50 w-64 bg-white p-4 border-r border-gray-200 shadow-lg md:relative md:translate-x-0">
                ...
                <ul>
                    ...
                    <li class="mb-4">
                        <a href="{{ route('admin.blog.list') }}"
                            ...
                            <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15.232 5.232l3.536 3.536m-2.036-5.036a1.25 1.25 0 011.768 1.768l-2.732 2.732m-3.536 3.536L12 18l-7.778-7.778a4 4 0 015.656-5.656L15.232 5.232z" />
                            </svg>
                            <span>My Posts</span>
                        </a>
                    </li>
